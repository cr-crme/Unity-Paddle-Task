...
/// <param name="_difficultyDefinition"></param>
/// <returns></returns>
public delegate bool ShouldTriggerDistraction(
    int currentLevel, Trial _trialData, DifficultyDefinition _difficultyDefinition
);
...
public class DifficultyDefinition
{
    public DifficultyDefinition(
        ...
        ShouldTriggerDistraction _shouldTriggerDistraction
    )
    {
        name = _name;
    ...
    private ShouldTriggerDistraction shouldTriggerDistraction;
    public bool AreDistractionCriteriaMet(int _currentLevel, Trial _trialData)
    {
        return shouldTriggerDistraction(_currentLevel, _trialData, this);
    }
