    ...
    public DifficultyFactory()
    {
        ...
        trialLevelDefinitions.Add(
            ...
            new DifficultyDefinition(
                ...
                (int _currentLevel, Trial _trialData, DifficultyDefinition _difficultyDefinition) => { return _trialData.nbAccurateBounces % 3 == 0; }
            )
        );
        ...
        trialLevelDefinitions.Add(
            ...
            new DifficultyDefinition(
                ...
                (int _currentLevel, Trial _trialData, DifficultyDefinition _difficultyDefinition) => { return _trialData.nbAccurateBounces % 5 == 0; }
        ...
        trialLevelDefinitions.Add(
            ...
            new DifficultyDefinition(
                ...
                (int _currentLevel, Trial _trialData, DifficultyDefinition _difficultyDefinition) => { return _trialData.nbAccurateBounces % 7 == 0; ; }
            )
        );
    }
}